...
const GlassInput = React.forwardRef<HTMLInputElement, GlassInputProps>(
  ({ className, icon, error, type, ...props }, ref) => {
    ...
    const glassStyle: React.CSSProperties = {
      ...
      boxShadow: isFocused
        ? "0 0 0 3px oklch(0.4 0.1 250 / 0.15), 0 2px 8px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.9)"
    ...
    return (
      <div className="relative">
        <motion.div
          className="flex items-center gap-2 sm:gap-3 rounded-[var(--radius)] px-4 sm:px-5 py-3 sm:py-3.5 transition-all duration-300 min-h-[44px]"
          style={glassStyle}
