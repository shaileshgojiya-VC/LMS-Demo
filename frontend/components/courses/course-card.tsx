  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }}>
      <GlassCard className="p-0 overflow-hidden hover:scale-[1.02] transition-transform relative h-full flex flex-col">
        {/* Course Image */}
        <div className="h-40 bg-gradient-to-br from-primary/20 to-accent/20 relative overflow-hidden cursor-pointer shrink-0" onClick={handleCardClick}>
          <img
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          {/* Instructor */}
          <div className="flex items-center mt-4 pt-4 border-t border-border/30 gap-3">
